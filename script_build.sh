...
PATH="${KERNEL_DIR}/../clang/bin:${KERNEL_DIR}/../aarch64/bin:${KERNEL_DIR}/../arm/bin:${PATH}"
...
export CROSS_COMPILE=$KERNEL_DIR/../aarch64/bin/aarch64-linux-android-
export CROSS_COMPILE_ARM32=$KERNEL_DIR/../arm/bin/arm-linux-androideabi-
